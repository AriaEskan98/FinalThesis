...
static Handle<Scene> BuildScene(AssetManager& assets)
{
    ...
    // -----------------------------------------------------------------------
    {
        ...
        auto& t  = e.GetComponent<TransformComponent>();
        t.Translation = { -2.0f, 0.0f, -3.5f }; // sitting on the ground
	...
	// -----------------------------------------------------------------------
	{
		...
		auto& t = e.GetComponent<TransformComponent>();
		t.Translation = { 2.0f, 0.0f, -3.5f };
		t.Rotation = { 0.0f, 0.0f, 0.0f };
		t.Scale = { 0.2f, 0.2f, 0.2f };

		auto& mr = e.AddComponent<MeshRendererComponent>();
		mr.Mesh = crateMesh;
		mr.Color = { 0.35f, 0.25f, 0.10f, 1.0f };
    ...
    // -----------------------------------------------------------------------
    {
        ...
        auto& t  = e.GetComponent<TransformComponent>();
        t.Translation = { 0.0f, 1.5f, -2.0f }; // start elevated; gravity brings to ground
